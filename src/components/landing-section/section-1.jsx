    ...
    <div className="section_1">
      <div className="contaner">
        ...
        <div className="backgroundImgs">
          <div className="hero00 hero" style={imageIndex.one ? {opacity: '1'} : {opacity: '0'}}>
            <span className='Names'></span>
          </div>
          <div className="hero01 hero" style={imageIndex.two ? {opacity: '1'} : {opacity: '0'}}>
            <span className='Names'></span>
          </div>
          <div className="hero02 hero" style={imageIndex.tree ? {opacity: '1'} : {opacity: '0'}}>
            <span className='Names'></span>
          </div>
        </div>
