      ...
      <div className="contaner">
        <div className="left">
          <div className="header">
            ...
            <span className="New_5">NEW</span>
          </div>
          <h2>
            A business solution designed for <span>teams</span>
          </h2>
          <h4>
            Upgrade to a curated experience packed with toopadding-rightls and
            benefits, dedicated to businesses
          </h4>
          <div className="check">
            <p>
              <FontAwesomeIcon icon={faCircleCheck} /> Connect to freelancers
